...
$(document).ready(function() {
    ...
    $('#table2').on( 'click', 'tbody tr', function () {
        ...
        var table2_cookie = [];
        for (i = 0; i < l; i++) {
          table2_cookie.push(table2.column(0).data()[i])
        }
        setCookie('table2_cookie', JSON.stringify(table2_cookie), 3);
    ...
    $('#table3').on( 'click', 'tbody tr', function () {
      ...
      var table3_cookie = [];
      for (i = 0; i < l; i++) {
        table3_cookie.push(table3.column(0).data()[i])
      }
      setCookie('table2_cookie', JSON.stringify(table3_cookie), 3);
